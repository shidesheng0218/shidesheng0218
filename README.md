...
[Projects](#-featured-projects) · [Product context](#-product-context) · [Principles](#-how-i-build) · [中文](#-中文简介)
...
| --- | --- | --- |
| [**RepoReady**](https://github.com/shidesheng0218/repo-ready) | Checks whether a repository is ready for Codex, Claude Code, Cursor, and human contributors. | A fast, no-server entry point to safer AI-assisted development. |
| [**Kimi Code Agent**](https://github.com/shidesheng0218/kimi-code-agent) | A native macOS coding-agent workspace with isolated worktrees, auditable tools, MCP / Skills / Hooks, and resumable execution. | Turns agent work into a reviewable local engineering process. |
| [**DeepSeek Code**](https://github.com/shidesheng0218/deepseek-code) | A local-first macOS agent harness for conversation, tools, approvals, evidence, and delivery state. | Makes verification status explicit instead of overstating experimental features. |
| [**agent-guard**](https://github.com/shidesheng0218/kimi-guard) | Runtime protection for coding agents: loop detection, quota gates, checkpoints, and supervised runs. | Helps prevent runaway loops before they spend the budget or damage the workspace. |
| [**kimi-boost**](https://github.com/shidesheng0218/kimi-boost) | One command to add agent skills, reviewer agents, safety hooks, and engineering conventions to a repository. | Makes a strong AI coding workflow repeatable across teams and stacks. |
| [**VLM-Diff**](https://github.com/shidesheng0218/vlm-diff) | Hybrid DOM + VLM visual regression testing with inspectable evidence. | Verifies UI changes deterministically first and uses model calls only when needed. |
...
- [**Open Support Agent Spec (OSAS)**](https://github.com/shidesheng0218/open-support-agent-spec) - an open, schema-first contract for governed customer-support agents.
- [**greenbump**](https://github.com/shidesheng0218/greenbump) - dependency upgrades that hand broken code to an AI repair loop until real builds and tests pass.
- [**buttonprobe**](https://github.com/shidesheng0218/buttonprobe) - detecting and repairing dead buttons in local React applications.
